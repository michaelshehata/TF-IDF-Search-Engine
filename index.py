...
# Techniques 
STOPWORDS = True # Removes top common words such as "of, the, as"
LEMMATISATION = True # Reduces different forms of a word to one single form for example "walking" to "walk"
STEMMING = False # Chops off prefixes and suffixes from words to obtain a common root for example "Changing" to "Chang"
...
def preprocess(text):
    ...
    clean_text = re.sub(r'<.+?>|\n', '', text)
    # replace hyphens with white space characters
...
def build_inverted_index_model(folder_name):
    ...
    for doc_id, document in enumerate(documents):
        # beautiful soup used to turn the document into text
